...
- **DWG 导出要如实说明限制**：DWG 无 Python 库可直接写，必须借本机转换器（ODA / LibreDWG /
  本机 CAD）。用 LibreDWG 时**尺寸标注会炸成普通块（DIMENSION 不保留）**，改图需人工补；
...
| **引导器（已校验）** | Release `v1.5.14`，SHA-256 `cae867a6…6460a` |
| 克隆体积 | ≈ 5 MB |
